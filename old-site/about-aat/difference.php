...
<head>
  ...
  <meta name="keywords" content="service animals, animal assisted therapy, therapy animals, therapy pets, therapets, trained therapy animals, trained animals, animal assisted therapy services, contact with animals, people who have disabilities, guide dogs for the blind, hearing dogs, mobility assistance dogs, seizure alert dogs">
  <meta name="description" content="Therapy Animals provide people with contact to animals, but are not limited to working with people who have disabilities while Service animals include guide dogs for the blind; hearing dogs, that alert their owners to sounds; mobility assistance dogs, which may pull a wheelchair or directly support a person; seizure alert dogs; and others.">
  <title>Difference between therapy animals and service animals - Animal Angels Foundation</title>
                ...
                <td valign="top">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber10">
                    ...
                    <tr>
                      ...
                      Learn About AAT - Difference between therapy pet and service animals</h3>
                      </td>
                    </tr>
                    <tr>
                      <td width="100%">
                      <p class="hd">What is the difference between therapy animals and service animals?</td>
                    </tr>
                    <tr>
                      <td width="100%">&nbsp;
                      </td>
                    ...
                    <tr>
                      <td width="100%">
                      <p align="justify">
                      <img border="0" src="/images/pic-therapy-pet.jpg" alt="A therapy pet" align="right" style="padding: 0px 0px 10px 15px;" width="115" height="174">
                      <p align="justify"><i><b>Therapy Animals</b></i> provide people with contact to animals, but are not limited to working with people who have disabilities. They are usually the personal pets of their handlers, and work with their handlers to provide services to people with developmental disorders, psychiatric disorders, physical disabilities, physical illnesses and behavioral / emotional problems.</p>
                      <p align="justify"><i><b>Service animals</b></i> include guide dogs for the blind; hearing dogs, that alert their owners to sounds; mobility assistance dogs, which may pull a wheelchair or directly support a person; seizure alert dogs; and others. </p>
                      <p align="justify">An animal is considered a &quot;service dog&quot; if it has been &quot;individually trained to do work or perform tasks for the benefit of a person with a disability&quot;.
                      </td>
                    </tr>
                  </table>
                </td>
