...
<head>
  ...
  <meta name="keywords" content="animal angels foundation, animal assisted therapy, therapy animals, animal assisted activities, trained therapy animals, trained animals, therapy pets, animal assisted therapy services, animal angels foundation mumbai, volunteer work, shrimati sunanda kele vidyamandir, nasik, nashik, prabodhini trust, buddy therapy dog, vinata, social skills, motor skills, verbal skills, children with emotional and behavioral problems">
  <meta name="description" content="Shrimati Sunanda Kele Vidyamandir, Nasik is a special school for children with developmental disabilities. Vinata and Buddy help these children improve their social skills, motor skills, and verbal skills.">
  <title>Shrimati Sunanda Kele Vidyamandir, Nasik - Animal Angels Foundation</title>
            ...
            <tr>
              <td width="100%" valign="top">
                <?
                  global $leftNav;
                  $leftNav = "sskv";
                  include($_SERVER['DOCUMENT_ROOT'] . "/common/leftMenus/volunteer.php");
                ?>
              </td>
            </tr>
            </table>
                ...
                <td valign="top">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber10">
                    ...
                    <tr>
                      ...
                      Angels at Work - Shrimati Sunanda Kele Vidyamandir, Nasik</h3>
                      </td>
                    </tr>
                    <tr>
                      <td width="100%">
                      <p align="justify"><img border="0" src="/images/pic-nasik_school.jpg" alt="Therapy dog Buddy along with Animal Angels Foundation volunteer Vinata help children improve their social, motor and verbal skills at Shrimati Sunanda Kele Vidyamandir, Nasik" align="left" hspace="10" width="250" height="256">This special school for children with developmental disabilities is run by the Prabodhini Trust of Nasik. The children wait eagerly for their favourite teacher Buddy who comes to meet them thrice a week. Our volunteer Vinata along with her therapy dog Buddy work with the physiotherapist and staff of the school. Together they help these children improve their social skills, motor skills, and verbal skills. Buddy also works with children who have emotional and behavioral problems.</p>
                      </td>
                    </tr>
                  </table>
                </td>
