...
<head>
  ...
  <meta name="keywords" content="animal angels foundation mumbai news, dna westcoast, guiding angels, shobha math, radhika nair, angel, rohini fernandes, clinical psychologist, manav foundation, cheshire home">
  ...
  <title>Animal Angels Foundation featured in DNA westcoast - Guiding Angels, Shobha Math</title>
          ...
          <div align="center">
            ...
            <script type="text/javascript">
			  ...
			  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber10">
				...
				DNA westcoast - January 14, 2007</h3>
				</td>
			    </tr>
			    <tr>
			  ...
			  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber12">
			    ...
			    <tr>
				<td width="100%">
				<center>Read the article on the <a target="_blank" href="http://digital.dnaindia.com/epapermain.aspx?queryed=33&eddate=1/14/2007">DNA</a> website and click on the link for page 4<br><font size="-2"><i>(You may need to register to view archives)</i></font><br>&nbsp;</center>
				</td>
			    </tr>
			    <tr>
				<td valign="top" width="100%">
				<img border="0" alt="DNA westcoast article on Animal Angels Foundation - January 14, 2007" src="/images/news-dna-2007-01-14.jpg" hspace="10" width="520" height="914">
				</td>
			    </tr>
			    </table>
