...
<head>
  ...
  <meta name="keywords" content="animal angels foundation mumbai news, dna westcoast, animals used to cure disabilities, sharleen d'souza, radhika nair, angel, rohini fernandes, simba, schizophrenia, children with developmental disabilities, dementia, alzheimer's, high blood pressure">
  <meta name="description" content="A dog is a man's best friend but Animal Angels Foundation have stretched this concept to a completely new level. Dogs and cats are used to treat the physically and mentally disabled.">
  <title>Animal Angels Foundation featured in DNA westcoast - Animals used to cure disabilities, Sharleen D'Souza</title>
          ...
          <div align="center">
            ...
            <script type="text/javascript">
		      ...
		      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber10">
		          ...
		          DNA westcoast - April 19, 2008</h3>
		          </td>
		        </tr>
			  <tr>
			    <td class="tch" width="100%"><center><b>Articles in the DNA and its supplements</b></center></td>
			  </tr>
		      </table>
		      ...
		      <?
		        global $midNav;
		        $midNav = "2008-04-19";
        		  include($_SERVER['DOCUMENT_ROOT'] . "/common/top/news-dna.php");
		      ?>
		      ...
		      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber12">
		        ...
		        <tr>
		          <td width="100%">
        		    <center>Read the article on the <a target="_blank" href="http://digital.dnaindia.com/epapermain.aspx?queryed=33&eddate=4/19/2008">DNA</a> website and click on the link for page 4<br><font size="-2"><i>(You may need to register to view archives)</i></font><br>&nbsp;</center>
			    </td>
			  </tr>
			  <tr>
			    <td valign="top" width="100%">
		          <img border="0" alt="DNA westcoast article on Animal Angels Foundation - Animals used to cure disabilities by Sharleen D'Souza on April 19, 2008" src="/images/news-dna-2008-04-19.jpg" hspace="10" width="520" height="1271">
			    </td>
		        </tr>
		      </table>
