...
<head>
  ...
  <meta name="keywords" content="animal angels foundation mumbai news, hindustan times, mumbai schools call in pets to tackle student problems, pet therapy helps city students solve behavioural problems, shweta nair, praful gangurde, hyperactive finish homework, pet therapy in schools, mumbai psychologist, janvi shethia, vaidehi tare, animal therapy helps speedy up recovery process">
  <meta name="description" content="Animal Angels Foundation in the Hindustan Times - Mumbai schools call in pets to tackle student problems and Pet therapy helps city students solve behavioural challenges by Shweta Nair, July 27, 2012">
  <title>Animal Angels Foundation featured in the Hindustan Times - Articles by Shweta Nair</title>
        ...
        <tr>
          ...
          <div align="center">
			...
			<tr>
			  ...
			  The Hindustan Times - July 27, 2012</h3>
			  </td>
			</tr>
			<tr>
			  <td class="tch" width="100%"><center><b>Articles in the Hindustan Times</b></center></td>
			</tr>
		      </table>
			...
			global $midNav;
			$midNav = "2012-07-27";
			include($_SERVER['DOCUMENT_ROOT'] . "/common/top/news-hindustan_times.php");
		      ?>
			...
			<tr>
			  <td width="100%">
			  <center>Read the article on <a href="http://www.hindustantimes.com/India-news/Mumbai/Mumbai-schools-call-in-pets-to-tackle-student-problems/Article1-900544.aspx" target="_blank">The Hindustan Times</a> website<br>&nbsp;</center>
			  </td>
			</tr>
			<tr>
			  <td valign="top" width="100%">
			  <img border="0" alt="The Hindustan Times article on Animal Angels Foundation - July 27, 2012" src="/images/news-hindustan-times-2012-07-27.jpg" align="center" hspace="10" width="520" height="1702">
			  </td>
			</tr>
		      </table>
